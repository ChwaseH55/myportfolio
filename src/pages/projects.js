...
import GC from "../assets/Landing.PNG";
...
import '../styles/Home.css'; // Ensure CSS file is included
  ...
  const projects = [
    {
      ...
      thumbnail: AKS, // Path to the image
    },
    {
      ...
      thumbnail: GC, // Path to the image
    },
    {
    ...
    },
    {
      ...
      thumbnail: Portfolio, // Path to the image
    },
